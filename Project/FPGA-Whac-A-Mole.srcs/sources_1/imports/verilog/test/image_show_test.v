module image_show_test(
    ...
    // 图片读取
    wire [11:0] pic_pixel_data; // 12-bit RGB pixel data
    image_reader_background_rgb u_background (
        .clk(vga_clk),
        .x(col_addr[9:0]),
        .y(row_addr[8:0]),
        .pixel_rgb(pic_pixel_data)
    );
    ...
    assign pixel_data = 
        ...
        {pic_pixel_data[3:0], pic_pixel_data[7:4], pic_pixel_data[11:8]}; // 背景图像
